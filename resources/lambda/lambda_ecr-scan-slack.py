...
def get_actual_repo(scan_result):
    return scan_result['repositoryName']
...
def lambda_handler(event, context):
    ...
    # Only construct the image scan summary and send if the captured repo matches the expected repo.
